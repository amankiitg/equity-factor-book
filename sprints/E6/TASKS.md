...
- [x] Task 0: ETF prices and the instrument set (P0)
...
- [x] Task 2: hedges on the seed books, both models (P0)
...
- [x] Task 3: realized efficacy and rebalancing decay (P0)
...
- [x] Task 4: evaluate F6.1 to F6.5 into RESULTS.json (P0)
...
- [x] Task 5: the research deliverable (P0)
...
- [x] Task 6: dashboard D5 Hedging Lab (P1)
...
- [x] Task 7: the walkthrough, the render and the engineering close (P0)
