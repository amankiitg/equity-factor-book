...
- [x] Task 0: probe the optional data sources (P0)
...
- [x] Task 1: the signal library (P0)
...
- [x] Task 3: the multiple-testing ledger (P0)
...
- [x] Task 4: evaluate F7.1 to F7.4 into RESULTS.json (P0)
...
- [x] Task 5: the signal reports and the alpha conversion (P0)
...
- [x] Task 6: dashboard D6 Alpha Lab (P1)
...
- [x] Task 7: the RG-Signal gate (P0)
...
- [x] Task 8: the walkthrough, the render and the engineering close (P0)
